...
Next.jsの9.3で導入されたgetStaticPropsを用いたSSG, および9.4で導入されたIncremental Static RegenerationとRelayが非常に相性がいい、ということを説明します。
...
Next.js/SSGを念頭に置くと、[useQuery](https://www.apollographql.com/docs/react/api/react-hooks/#usequery)やQueryコンポーネントなどの機能は使わなくなります。
...
なお、relayにも[hooksサポートはあります](https://github.com/relay-tools/relay-hooks)
